<template>
    <div class="view">
        <div class="header">
            <div class="logo"><img class="logo_img" src="logo/full_logo_black.png" alt="" @click="goTo('/')"></div>
            <div class="contact">
        ...
        <div class="top" ref="top">
            <div class="content">
                <div class="title_block">
                    <div class="title">Moruvi Moments</div>
                    <div class="subTitle">
                    ...
                    <div class="box">
                        <div class="btn btn-1" @click="goTo('/moruvi')">進入基地 <i class="fa-solid fa-arrow-right start-arrow"></i></div>
        ...
        <div class="skill">
            ...
            <div class="skill_box_wrapper">
                ...
                <div class="skill_box">
                    ...
                    <div class="skill_box_img">
                        <img src="img/coding.png" decoding="async" alt="">
                    </div>
                </div>
                <div class="skill_box">
                    ...
                    <div class="skill_box_img">
                        <img src="img/learning.png" decoding="async" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="footer" ref="contact">
            <div class="footer_item">
                ...
                <div>Copyright © 2026 Moruvi Moments All Rights Reserved</div>
            </div>
        </div>
...
export default {
    ...
    data(){
        return {
            ...
            subTextForPC:'A private space where every moment between us becomes a memory worth keeping.',
            subTextForMobile: 'Where every moment becomes a memory.',
            subTextEls:[],
            feedbackImg:[{
